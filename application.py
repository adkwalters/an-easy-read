...
class ConfigClass(object):
    ...
    TEMPLATES_AUTO_RELOAD = True    # Auto-reloads templates upon change

    # Configure file upload criteria
    MAX_CONTENT_LENGTH = 1024 * 1024  # Set maximum file upload size to 1mb
    UPLOAD_PATH = 'static\images' # Set file upload folder
    UPLOAD_EXTENSIONS = {'.jpg', '.png', '.gif'} # Set permitted file types
...
def create_app():
    ...
    # Create Flask app and load app.congig
    app = Flask(__name__)
